...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        main::after { bottom: -80px; left: -40px; background: radial-gradient(circle, rgba(52, 211, 153, 0.35), transparent 75%); }
        .eyebrow {
...
<main>
    ...
    <p>Our team has been notified, and we’re already looking into it. Please try refreshing the page or come back in a couple of minutes.</p>
    <div class="actions">
        <a class="primary" href="{{ url()->previous() ?? url('/') }}">Try again</a>
        <a class="ghost" href="{{ url('/') }}">Return home</a>
    </div>
</main>
</body>
</html>
